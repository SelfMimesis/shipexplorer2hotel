(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      ".shipexplorer-popup-theme-ship{--shipexplorer-popup-panel:rgba(42,18,54,.94);--shipexplorer-popup-line:#9D00FF;--shipexplorer-popup-inner:rgba(184,77,255,.34);--shipexplorer-popup-halo:rgba(157,0,255,.22);--shipexplorer-popup-text:#F3E8FF;--shipexplorer-popup-muted:#98AA39;--shipexplorer-popup-accent:#FF8A00;}",
      ".shipexplorer-popup-theme-hotel{--shipexplorer-popup-panel:rgba(6,27,32,.95);--shipexplorer-popup-line:#2CF6FF;--shipexplorer-popup-inner:rgba(19,184,174,.32);--shipexplorer-popup-halo:rgba(44,246,255,.2);--shipexplorer-popup-text:#EAFEFF;--shipexplorer-popup-muted:#7ECBC4;--shipexplorer-popup-accent:#FF2F55;}",
      ".shipexplorer-popup-theme-dark{--shipexplorer-popup-panel:rgba(0,0,0,.96);--shipexplorer-popup-line:#8830BF;--shipexplorer-popup-inner:rgba(136,48,191,.32);--shipexplorer-popup-halo:rgba(157,0,255,.2);--shipexplorer-popup-text:#F3E8FF;--shipexplorer-popup-muted:#98AA39;--shipexplorer-popup-accent:#9D00FF;}",
      ".shipexplorer-popup-theme-light{background:rgba(0,0,0,.62);--shipexplorer-popup-panel:rgba(243,232,255,.96);--shipexplorer-popup-line:#8830BF;--shipexplorer-popup-inner:rgba(136,48,191,.24);--shipexplorer-popup-halo:rgba(157,0,255,.18);--shipexplorer-popup-text:#000000;--shipexplorer-popup-muted:#674080;--shipexplorer-popup-accent:#9D00FF;}",
