(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ".shipexplorer-popup-overlay{position:fixed;inset:0;display:grid;place-items:center;padding:24px;background:rgba(0,0,0,.72);font-family:Consolas,'Courier New',monospace;box-sizing:border-box;}",
      ".shipexplorer-popup-overlay[hidden]{display:none!important;}",
      ".shipexplorer-popup-overlay *{box-sizing:border-box;}",
      ".shipexplorer-popup-panel{position:relative;width:min(560px,calc(100vw - 48px));min-height:170px;padding:30px 30px 24px;border:1px solid var(--shipexplorer-popup-line);background:linear-gradient(135deg,rgba(255,255,255,.13),rgba(255,255,255,.035)),var(--shipexplorer-popup-panel);color:var(--shipexplorer-popup-text);box-shadow:0 0 0 1px var(--shipexplorer-popup-halo),0 24px 90px rgba(0,0,0,.5);overflow:hidden;backdrop-filter:blur(16px) saturate(1.25);-webkit-backdrop-filter:blur(16px) saturate(1.25);}",
      ...
      ".shipexplorer-popup-theme-ship{--shipexplorer-popup-panel:rgba(42,18,54,.76);--shipexplorer-popup-line:#9D00FF;--shipexplorer-popup-inner:rgba(184,77,255,.34);--shipexplorer-popup-halo:rgba(157,0,255,.22);--shipexplorer-popup-text:#F3E8FF;--shipexplorer-popup-muted:#98AA39;--shipexplorer-popup-accent:#FF8A00;}",
      ".shipexplorer-popup-theme-hotel{--shipexplorer-popup-panel:rgba(6,27,32,.72);--shipexplorer-popup-line:#2CF6FF;--shipexplorer-popup-inner:rgba(19,184,174,.32);--shipexplorer-popup-halo:rgba(44,246,255,.2);--shipexplorer-popup-text:#EAFEFF;--shipexplorer-popup-muted:#7ECBC4;--shipexplorer-popup-accent:#FF2F55;}",
      ".shipexplorer-popup-theme-dark{--shipexplorer-popup-panel:rgba(0,0,0,.72);--shipexplorer-popup-line:#8830BF;--shipexplorer-popup-inner:rgba(136,48,191,.32);--shipexplorer-popup-halo:rgba(157,0,255,.2);--shipexplorer-popup-text:#F3E8FF;--shipexplorer-popup-muted:#98AA39;--shipexplorer-popup-accent:#9D00FF;}",
      ".shipexplorer-popup-theme-light{background:rgba(0,0,0,.62);--shipexplorer-popup-panel:rgba(243,232,255,.76);--shipexplorer-popup-line:#8830BF;--shipexplorer-popup-inner:rgba(136,48,191,.24);--shipexplorer-popup-halo:rgba(157,0,255,.18);--shipexplorer-popup-text:#000000;--shipexplorer-popup-muted:#674080;--shipexplorer-popup-accent:#9D00FF;}",
      ".shipexplorer-popup-variant-info{--shipexplorer-popup-accent:#9D00FF;}",
      ".shipexplorer-popup-variant-warning{--shipexplorer-popup-accent:#FF8A00;}",
      ".shipexplorer-popup-variant-danger{--shipexplorer-popup-accent:#FF4D00;}",
      ".shipexplorer-popup-variant-success{--shipexplorer-popup-accent:#98AA39;}",
      ...
      ".shipexplorer-video-overlay{position:fixed;inset:0;width:100vw;height:100vh;margin:0;padding:0;background:#000000;overflow:hidden;z-index:999999;isolation:isolate;box-sizing:border-box;overscroll-behavior:contain;}",
      ...
      ".shipexplorer-video-status{position:absolute;left:50%;top:50%;z-index:2;transform:translate(-50%,-50%);padding:9px 12px;border:1px solid rgba(243,232,255,.75);background:rgba(0,0,0,.72);color:#F3E8FF;font-family:Consolas,'Courier New',monospace;font-size:12px;letter-spacing:.12em;text-transform:uppercase;}",
      ".shipexplorer-video-close{position:absolute;left:50%;top:calc(50% + 44px);z-index:2;transform:translateX(-50%);min-height:36px;border:1px solid rgba(243,232,255,.75);background:rgba(0,0,0,.72);color:#F3E8FF;font-family:Consolas,'Courier New',monospace;font-size:12px;letter-spacing:.1em;text-transform:uppercase;padding:8px 12px;cursor:pointer;}",
      ".shipexplorer-video-close:hover{border-color:#FF8A00;color:#FF8A00;}",
